...
final class ESS_Elements
{
	...
	{
		?><link rel="alternate" type="application/ess+xml" title="<?php _e('ESS Feed of all the events published in the website and available for syndication.','em-ess').' ('.ESS_IO::ESS_WEBSITE .')'; ?>"  href="<?php echo ESS_IO::get_feed_url(); ?>" /><?php
	}

	public static function get_feed_meta_link()
	{
		?><li>
			<a href="<?php echo ESS_IO::get_feed_url(); ?>" target="_blank" title="<?php _e('ESS Feed of all the events published in the website and available for syndication.','em-ess');?>">
				<?php _e( "Events ESS",'em-ess' ); ?>
			</a>
		</li><?php
	}
	...
	{
		return "<a href='".ESS_IO::get_feed_url( $event_id )."' target='_blank' title='".__('ESS Feed of all the events published in the website and available for syndication.','em-ess')."'>".
			"<img src='".EM_ESS_URL."/assets/img/ESS_logo_16x16.png' title='" . __( "Events content with ESS Feed format", 'em-ess' ) ."' style='margin-right:6px;'/>".
		"</a>";
	}

	private static function get_robby_signature()
	{
		return "<p style='color:rgb(153,153,153);font-size:11px;padding:0;margin:0;display:inline;'>" .
			__( "Events available in ", 'em-ess' ) .
			" <a href='".ESS_IO::ROBBY_WEBSITE."' target='_blank' alt='" . __( "Robby Events Search Engine / AI Calendar Assistant", 'em-ess' )."'>" .
				__( "ROBBY", 'em-ess' ) .
			"</a>".
		"</p>";
	}
	...
	public static function get_output_single( $content='' )
	{
		...
		return $content .
		//( ( get_option( 'ess_feed_push' ) )?self::get_robby_signature() : '' ).
	...
	public static function get_explain_block( $txt='' )
	{
		?><div class="ess_explain">
			<img src="<?php echo EM_ESS_URL. '/assets/img/info_icon_30x30.png'; ?>" alt="<?php _e('Info','em-ess');?>" />
			<p><?php _e( $txt, "em-ess" ); ?></p>
		</div><?php
	}
	...
	{
		?><div class="update-nag">
			<?php _e( "PHP cURL must be installed on your server: ", 'em-ess' ); ?>
