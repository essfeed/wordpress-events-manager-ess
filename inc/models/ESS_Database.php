...
final class ESS_Database
{
	...
	public static $SOCIAL_PLATFORMS = array(
		...
		'events' 	=> array( 'foursquare', 'eventbrite', 'robby', 'meetup', 'eventful' ),
	...
	public static function createTable()
	{
		...
		ESS_Database::$sql = "CREATE TABLE " . ESS_Database::$table . " (
			...
			feed_event_ids 	TEXT            CHARACTER SET utf8 COLLATE utf8_unicode_ci 	NOT NULL,
			feed_post_ids 	TEXT            CHARACTER SET utf8 COLLATE utf8_unicode_ci 	NOT NULL,
	...
	public static function set_default_values()
	{
		...
		$ess_options = array(
			...
			// -- Feed Settings
			'ess_feed_title' 			=> sprintf( __( 'Events from: %s', 'em-ess' ), @$_SERVER[ 'HTTP_HOST' ] ),
			'ess_feed_rights'			=> sprintf( __( '© ESS | Events Manager %s', 'em-ess' ), date( 'Y' ) ),
